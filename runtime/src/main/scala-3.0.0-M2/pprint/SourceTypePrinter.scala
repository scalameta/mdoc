...
/** Printer for fully elaborated representation of the source code without the added prefix
 *  This is code is copied from Dotty and until https://github.com/lampepfl/dotty/issues/9716 
 *  is fixed it's the best way to print types we have.
 */
class SourceTypePrinter[Q <: Quotes & Singleton](syntaxHighlight: SyntaxHighlight)(using val quotes: Q) {
